...
- `pnpm dlx storybook automigrate --config-dir .storybook`

- `pnpm dlx storybook automigrate --config-dir libs/block/ui/.storybook`

- `pnpm dlx storybook automigrate --config-dir libs/blog-post/ui/.storybook`
