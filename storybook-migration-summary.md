...
- `npx storybook@latest automigrate --config-dir libs/block-ui/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/blog-post-ui/.storybook --renderer @storybook/angular`
